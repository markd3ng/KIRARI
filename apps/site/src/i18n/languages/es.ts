...
export const es: Translation = {
	...
	[Key.sponsorButton]: "Patrocinar",
	[Key.sponsorButtonText]: "Si este artículo te ayudó, ¡considera apoyarme!",
	[Key.copyLink]: "Copiar Enlace",
	[Key.copied]: "¡Copiado!",
	[Key.bangumi]: "Bangumi",
	[Key.bangumiLoading]: "Cargando Bangumi...",
	[Key.bangumiEmpty]: "No hay elementos de Bangumi.",
	[Key.bangumiError]: "No se pudo cargar Bangumi.",
	[Key.bangumiScore]: "Puntuación",
	[Key.bangumiUntitled]: "Sin título",
	[Key.devices]: "Dispositivos",
	[Key.devicesSubtitle]: "Aquí están los dispositivos que uso",
